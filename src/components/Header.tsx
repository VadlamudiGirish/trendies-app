  ...
  return (
    <header className="bg-gray-900 text-white shadow-md">
      ...
      >
        ...
        <div className="flex items-center space-x-6">
          ...
          {session ? (
            <button
              onClick={() => signOut()}
              className="hidden lg:inline-flex px-4 py-2 text-sm font-semibold text-gray-300 hover:text-white hover:bg-gray-800 rounded-md transition"
            >
              Logout
            </button>
          ) : (
            <button
              ...
              className="hidden lg:inline-flex items-center space-x-2 px-4 py-2 text-sm font-semibold text-white bg-[#24292F] hover:bg-[#333] rounded-md transition"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-md p-2 text-gray-300 hover:text-white focus:outline-none lg:hidden"
          >
      ...
      <Dialog
        ...
        className="lg:hidden"
      >
        <div className="fixed inset-0 bg-gray-800/75 z-20" />
        <DialogPanel className="fixed inset-y-0 left-0 z-30 w-full bg-gray-900 p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex p-2 text-gray-300 hover:text-white focus:outline-none"
            >
